...
#import "RedPacketLuckCell.h"
#import "RedpacketOpenConst.h"
#import "UIImageView+EMWebCache.h"
#import "RedPacketLuckView.h"
#import "RedpacketMessageModel.h"

@interface RedPacketLuckCell()

@property (nonatomic, strong) RedPacketLuckView *redpacketView;

@end

@implementation RedPacketLuckCell
...
- (RedPacketLuckView *)redpacketView
{
    if (!_redpacketView) {
        _redpacketView = [[RedPacketLuckView alloc]init];
    }
